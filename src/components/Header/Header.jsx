...
import { useNavigate } from "react-router-dom"; // ✅ ավելացրել ենք
import "./Header.css";
...
function Header() {
  ...
  const handleProfileClick = () => {
    navigate("/profile"); // ✅ նավարկում դեպի Profile էջ
  };

  return (
    <div>
      <header className="header m-0 w-full bg-[#65E36A] rounded-b-[20px]">
        <div className="header-container py-[15px] px-0">
          <div className="header-wrapper container flex items-center justify-between mx-auto">
            <div className="flex items-center cursor-pointer" onClick={() => navigate("/")}>
              {/* logo → տանելու է գլխավոր էջ (օր.՝ Start) */}
              <img src="/images/logo.png" className="header-logo w-[101px] h-[120px]" />
              <div className="title flex flex-col text-sm/16 font-[Roboto] text-[#4F4F4F]">
                <h2 className="text-5xl font-medium font-[Roboto] text-[#4F4F4F]">
                  GoodRent.
                </h2>
                <p className="text-xs font-normal max-w-[207px]">
            ...
            <div className="list w-[800px]">
              <ul className="nav-list flex justify-between w-full list-none text-lg font-medium pt-[63px]">
                <li className="cursor-pointer pb-[51px]" onClick={() => navigate("/search")}>
                  Поиск
                </li>
            ...
            {/* profile */}
            <div
              className="flex items-center max-w-[337px] gap-[37px] cursor-pointer"
              onClick={handleProfileClick} // ✅ նավարկում դեպի /profile
            >
              ...
              <div className="flex flex-col gap-2.5">
                <div className="flex items-center gap-2.5 about-profile">
                  ...
                  />
                  <p className="max-w-[212px] text-base font-medium">
